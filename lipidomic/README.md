# Lipidomic analysis - EpiClim F0 Liver
Untargeted lipidomic analysis of adult female zebrafish liver samples following developmental exposure to combined climate stressors and PFOS.

## Files
- `.Rmd` — Analysis source code
- `.html` — Rendered analysis
- `.xlsx` files — Input data (lipid intensities + metadata)
